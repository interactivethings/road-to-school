...
export function outOfSchool(force, data, {width, height}) {
  // console.log('outOfSchool')
    ...
    force
        ...
        .force('ySchool', isolate(data, d3.forceY(height*0.8/2), function(d) { return d.type === 'school' ; }).strength(function(d,i) { return d.id/(data.length*8); }))
        ...
        .force('yNoSchool', isolate(data, d3.forceY(function(d,i) { return Math.cos(i) * R * getVariation(0.8,1) + (height*0.8/2);} ), function(d) { return d.type === 'noSchool'; }).strength(0.2))  
...
export function backToSchool(force, data, {width, height}) {
  ...
  force
    ...
    .force('ySchool', isolate(data, d3.forceY(height*0.8/2), function(d) { return d.type === 'school' ; }).strength(0.8))
    .force('xNoSchool', isolate(data, d3.forceX(width*0.7/2), function(d) { return d.type === 'noSchool' ; }).strength(0.8))      
    .force('yNoSchool', isolate(data, d3.forceY(height*0.8/2), function(d) { return d.type === 'noSchool' ; }).strength(0.8))
