...
export function bomb(force, data, {width, height}, ratio) {
    ...
    d3.forceSimulation(data)
        .alphaTarget(0.5)
        .force('bombX', d3.forceX(function(d,i) { return Math.sin(i) * 10 + width/2;} ).strength(-0.2))
        .force('bombY', d3.forceY(function(d,i) { return Math.cos(i) * 10 + height/2;} ).strength(-0.2))
        .velocityDecay(0.5)
        .stop()
        .tick();
