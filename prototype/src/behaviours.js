...
export function baseline(force, data, {width, height}) { 
  ...
  force
    ...
    .force('collideSchool', isolate(data, d3.forceCollide(), function(d) { return d.type === 'school' ; }).radius(function(d) { return d.r * 4; }).strength(0.8)) 
    .force('collideNoSchool', isolate(data, d3.forceCollide(), function(d) { return d.type === 'noSchool' ; }).radius(function(d) { return d.r * 4; }).strength(0.8)) 
...
export function outOfSchool(force, data, {width, height}) {
    ...
    force
        ...
        .force('xNoSchool', 
            ...
            .strength(0.1 * getVariation(1,1.2)))      
        .force('yNoSchool', 
            isolate(data, d3.forceY(function(d) { return Math.cos(d.id) * R + (height*0.8/2);} ), function(d) { return d.type === 'noSchool'; })
            .strength(0.1 * getVariation(1,1.2)))  
        .force('collideSchool', 
            isolate(data, d3.forceCollide(), function(d) { return d.type === 'school' ; }).radius(function(d) { return d.r * 4; }).strength(0.5)) 
...
export function backToSchool(force, data, {width, height}) {
  ...
  force
    ...
    .force('collideSchool', isolate(data, d3.forceCollide(), function(d) { return d.type === 'school' ; })
        .radius(function(d) { return d.r * 4; }).strength(0.6)) 
